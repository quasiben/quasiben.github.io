...
Not wanting to repeat the mistakes of the past and hearing great things about [GCE](https://cloud.google.com/compute/) and [Kubernetes](https://kubernetes.io/) we committed early on to the Google Cloud Platform.  Generously, Google donated resources for us to build out and iterate on our tutorial cluster platform.  We are extremely appreciative of their support!
...
*I should also note that my friend and colleague, [Daniel Rodriguez](http://danielfrg.com/), contributed significantly to this effort and he worked out much of architecture and implementation with Kubernetes.*
...
With a functional API we can wrap various can now dynamically construct models and build namespaces as part of a web application.  Using [tornado](https://www.tornadoweb.org/) seems like a good choice here since the app is mostly idling.  Let's dig in a bit to what the cluster Docker setup is made of.
